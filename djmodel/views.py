...
class NotificationView(GenericAPIView):
    ...
    def post(self, request):
        push_service = FCMNotification(api_key='''AAAAnN1TIdw:APA91bGRfLfJJpxML0vtZ2SaQqyr9YHpCuHfbEMRv8NAj0zDK9mNMgUcJL8g
        EwG4sVVx9Aj0O6fpNfaOQSTHenVTuKxYhhioVNaIzPzVtej98gvq80arWd5M3MoaXiUl4kZSdW2miYuB''')
